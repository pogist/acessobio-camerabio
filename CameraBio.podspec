#
#  Be sure to run `pod spec lint CameraBio.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/acesso-io/acessobio-camerabio.git", :tag => "1.1.1" }
  ...
  spec.source_files  = "CameraBio", "CameraBio/**/*.{h,m}"
